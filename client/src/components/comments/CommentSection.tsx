...
export default function CommentSection({ postId, commentCount }: { postId: string; commentCount: number }) {
  ...
  return (
    <div className="_feed_inner_timeline_cooment_area _padd_r24 _padd_l24">
      <div className="_feed_inner_comment_box _mar_b16"><div className="_feed_inner_comment_box_image">{user && <Avatar user={user} className="_comment_img" />}</div><ReplyComposer postId={postId} placeholder="Write a comment" /></div>
