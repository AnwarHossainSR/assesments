      ...
      <div className="collapse navbar-collapse" id="feedNavigation">
        ...
        <div className="_header_nav_profile">
          ...
          {profileOpen && <div className="_nav_profile_dropdown _profile_dropdown show">
            <div className="_nav_profile_dropdown_info"><div className="_nav_profile_dropdown_image">{user && <Avatar user={user} className="_nav_drop_img" />}</div><div className="_nav_profile_dropdown_info_txt"><h4 className="_nav_dropdown_title">{name}</h4><a href="#profile" className="_nav_drop_profile">View Profile</a></div></div><hr />
            <ul className="_nav_dropdown_list">{menuItems.map((item) => <li className="_nav_dropdown_list_item" key={item.label}>{item.href ? <a href={item.href} className="_nav_dropdown_link" onClick={() => setProfileOpen(false)}><div className="_nav_drop_info"><span><MenuIcon kind={item.kind} /></span>{item.label}</div><Chevron /></a> : <button type="button" className="_nav_dropdown_link" onClick={() => logout()}><div className="_nav_drop_info"><span><MenuIcon kind={item.kind} /></span>{item.label}</div><Chevron /></button>}</li>)}</ul>
          </div>}
        </div>
      </div>
    </div></nav>

    <div className="_header_mobile_menu"><div className="_header_mobile_menu_wrap"><div className="container"><div className="_header_mobile_menu_top_inner"><div className="_header_mobile_menu_logo"><a href="/feed"><img src="/assets/images/logo.svg" alt="BuddyScript" className="_nav_logo" /></a></div><div className="_header_mobile_menu_right"><button type="button" className="_header_mobile_search" aria-label="Search"><svg width="17" height="17" fill="none" viewBox="0 0 17 17"><circle cx="7" cy="7" r="6" stroke="#666" /><path stroke="#666" strokeLinecap="round" d="m16 16-3-3" /></svg></button></div></div></div></div></div>
    <div className="_mobile_navigation_bottom_wrapper"><div className="_mobile_navigation_bottom_wrap"><div className="container"><ul className="_mobile_navigation_bottom_list"><li className="_mobile_navigation_bottom_item"><a href="/feed" className="_mobile_navigation_bottom_link _mobile_navigation_bottom_link_active" aria-label="Feed"><HomeIcon mobile /></a></li><li className="_mobile_navigation_bottom_item"><a href="#friends" className="_mobile_navigation_bottom_link" aria-label="Friends"><PeopleIcon /></a></li><li className="_mobile_navigation_bottom_item"><button type="button" className="_mobile_navigation_bottom_link" aria-label="Notifications"><BellIcon /><span className="_counting">6</span></button></li><li className="_mobile_navigation_bottom_item"><a href="#chat" className="_mobile_navigation_bottom_link" aria-label="Messages"><ChatIcon /><span className="_counting">2</span></a></li></ul></div></div></div>
  </>;
}
